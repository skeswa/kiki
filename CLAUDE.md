...
- For behavior questions (what does `kk x` do?): `docs/book/04-invariants.md` first, then the relevant chapter in `docs/book/`.
- For structure questions (which crate, which sqlite table, which gRPC method?): `docs/book/15-architecture/`.
- For "why is it this way?": `docs/appendix/decisions/` for ADR-style rationale.
- For deferred surfaces (v2 MCP substrate, etc.): `docs/book/18-roadmap.md`.
- For terminology: `docs/book/02-glossary.md`.
- For product intent and v1 scope: `docs/book/00-abstract.md`, `docs/book/01-orientation.md`, and `docs/book/03-user-stories.md`.
